...
class MyCalc:
    def __init__(self,root):
        ...
        self.lbl1 = Label(frame1,text="Enter 1st num: ",fg="blue",bg = "white", font = (16))
        ...
        self.lbl2 = Label(frame2,text="Enter 2nd num: ",fg="blue",bg = "white",font = (16))
        ...
        frame3 = Frame(root)
        frame3.pack(fill=X)
        self.lbl3 = Label(frame3,text="Result is:           ",fg="blue",bg = "white",font = (16))
